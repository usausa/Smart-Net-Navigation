...
internal sealed class RotateAnimation : IWindowsNavigationAnimation
{
    private readonly double angle;

    private readonly TimeSpan duration;

    public RotateAnimation(double angle = 180d, TimeSpan? duration = null)
    {
        this.angle = angle;
    ...
    public Task PlayAsync(WindowsNavigationAnimationContext context)
    {
        ...
        {
            WindowsNavigationAnimationPhase.Open or WindowsNavigationAnimationPhase.Activate => (-angle, 0d, 0d, 1d),
            WindowsNavigationAnimationPhase.Close or WindowsNavigationAnimationPhase.Deactivate => (0d, angle, 1d, 0d),
            _ => (0d, 0d, 1d, 1d),
        };
