...
internal sealed class DialogAnimation : IWindowsNavigationAnimation
{
    private readonly double minScale;

    private readonly TimeSpan duration;

    public DialogAnimation(double minScale = 0.7d, TimeSpan? duration = null)
    {
    ...
    public Task PlayAsync(WindowsNavigationAnimationContext context)
    {
        ...
        {
            WindowsNavigationAnimationPhase.Open or WindowsNavigationAnimationPhase.Activate => (minScale, 1d, 0d, 1d),
            WindowsNavigationAnimationPhase.Close or WindowsNavigationAnimationPhase.Deactivate => (1d, minScale, 1d, 0d),
            _ => (1d, 1d, 1d, 1d),
        };
